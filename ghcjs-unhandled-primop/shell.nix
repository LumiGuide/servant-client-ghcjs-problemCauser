...
let
  ...
  f = { mkDerivation, base, servant
      , servant-client, servant-server, stdenv, ghcjs, ghcjs-base, ghcjs-prim, warp, text, http-client, transformers, http-api-data
      }:
      mkDerivation {
        ...
        executableHaskellDepends = [
          base ghcjs-base ghcjs-prim servant servant-client servant-server warp text http-client transformers http-api-data
        ];
